use crate::inbox::nl::*;
use crate::serialize;
use crate::serialize::QDiscUpdateMsg;
use portus::ipc;
...
impl Datapath for Qdisc {
    ...
    fn set_epoch_length(&mut self, epoch_length_packets: u32) -> Result<(), portus::Error> {
        ...
        debug!(self.logger, "adjust_epoch";
